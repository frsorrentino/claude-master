...
T.check("U5 a ✗ session gets Riprendi (callback reopen: relaunch it, 15/09) instead of Continua; ❓ gets neither", [r[0]["text"] for r in ui.keyboard_card([], state="dead")["inline_keyboard"]] == ["Avvisami", "Riprendi", "Sessioni"] and ui.keyboard_card([], state="dead")["inline_keyboard"][1][0]["callback_data"] == "reopen" and not {"Continua", "Riprendi"} & {r[0]["text"] for r in ui.keyboard_card(["A"], state="waiting")["inline_keyboard"]}, "")
T.check("U2 riapri / reopen → reopen; riprendi stays resume", P("riapri") == ("reopen", "") and P("reopen") == ("reopen", "") and P("riprendi") == ("resume", ""), str([P("riapri"), P("reopen")]))
